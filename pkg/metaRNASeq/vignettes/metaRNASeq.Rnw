...
IDDIRR(fishcomb_de,indstudy_de)
IDDIRR(invnorm_de ,indstudy_de)
@
<<calcul2,eval=TRUE,echo=FALSE>>=
x=IDDIRR(fishcomb_de,indstudy_de)
y=IDDIRR(invnorm_de ,indstudy_de)
@
